...
//    }
    ...
    public void setNumOfWins(int numOfWins) {
        this.numOfWins = numOfWins;
        Repository.getInstance().saveNumOfWins(this.numOfWins);
    }
    ...
    public ArrayList<Skin> returnNewAllSkinsArrayList(){
        ...
        Skin peace = new Skin("Peace", "Win 1 match.", false, false, R.drawable.skin_peace, 0);
        Skin pizza = new Skin("Pizza?", "Win 2 matches.", false, false, R.drawable.skin_pizza, 0);
        Skin musical = new Skin("Musical", "Win 3 matches.", false, false, R.drawable.skin_musical, 0);
        Skin hamburger = new Skin("Burger", "Win 4 matches.", false, false, R.drawable.skin_hamburger, 0);
        Skin smile = new Skin("Smile", "Win 5 matches.", false, false, R.drawable.skin_smile, 0);
        Skin ocean = new Skin("Ocean", "Win 6 matches.", false, false, R.drawable.skin_ocean, 0);
        Skin telescope = new Skin("Telescope", "Win 7 matches.", false, false, R.drawable.skin_telescope, 0);
        Skin playin = new Skin("Playin'", "Win 8 matches.", false, false, R.drawable.skin_playin, 0);
        Skin crystal = new Skin("Crystal", "Win 9 matches.", false, false, R.drawable.skin_crystal, 0);
        Skin master = new Skin("Master", "Win 10 matches.", false, false, R.drawable.skin_master, 0);
