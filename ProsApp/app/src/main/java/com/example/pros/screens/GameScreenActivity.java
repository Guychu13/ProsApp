...
public class GameScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isMultiplayer = originIntent.getExtras().getBoolean("isMultiplayer", false);
        isP1 = originIntent.getExtras().getBoolean("isP1", false);
        isSplitScreen = originIntent.getExtras().getBoolean("isSplitScreen", false);
    }
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        gameView = new GameView(this, isMultiplayer, isP1, isSplitScreen, windowHeight, windowWidth, User.getInstance().getChosenSkinImageId(), new ScoreHandler());
            ...
            if (timerPauseDurationMilliSecs != 0) {
                ...
                if (gameTimerSecondsLeft <= 0) {
                    if (myBlockScore > enemyCpuBlockScore && !winScreenHasAppeared) {
                        ...
                        User.getInstance().setNumOfWins(User.getInstance().getNumOfWins() + 1);
                    ...
                    else if(myBlockScore == enemyCpuBlockScore && didOvertime && !winScreenHasAppeared){
                        gameView.setGameOver();
                        Intent intent = new Intent(GameScreenActivity.this, WinAndLossScreenActivity.class);
