 ...
 */
public class MainScreenActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    public void openDuelDialog(View view){
        duelDialog = new Dialog(MainScreenActivity.this);
        duelDialog.setContentView(R.layout.dialog_duel_modes);
        duelDialog.setCanceledOnTouchOutside(true);
        duelDialog.setCancelable(true);
        duelDialog.show();
    }
    ...
    public void goToSplitScreenGame(View view){
        Intent intent = new Intent(MainScreenActivity.this, GameScreenActivity.class);
        intent.putExtra("isSplitScreen", true);
        startActivity(intent);
    }
...
//                                }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()){
            case R.id.mainScreen_menu_about:
    ...
    public void showPopup(View view) {
        ...
        popup.inflate(R.menu.main_screen_menu);
        popup.show();
    }
}
