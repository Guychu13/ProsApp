...
public class WinAndLossScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(winner.equals("myBlock")){
            ...
            titleTextView.setText(getResources().getString(R.string.WinAndLossScreen_draw_title));
            secondTextTextView.setText(getResources().getString(R.string.WinAndLossScreen_draw_secondText));
        }
        else{
